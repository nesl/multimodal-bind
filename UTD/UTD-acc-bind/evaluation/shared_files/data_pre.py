...
def load_data_incomplete_modality(data_path, select_modality):
	...
	if select_modality == "acc":
		x2 = np.zeros_like(x2)
		x3 = np.zeros_like(x3)
	elif select_modality == "skeleton":
		x1 = np.zeros_like(x1)
		x3 = np.zeros_like(x3)
	elif select_modality == "gyro":
		x1 = np.zeros_like(x1)
		x2 = np.zeros_like(x2)
	elif select_modality == "acc_gyro":
		x2 = np.zeros_like(x2)
	elif select_modality == "skeleton_gyro":
		x1 = np.zeros_like(x1)
	elif select_modality == "acc_skeleton":
		x3 = np.zeros_like(x3)
