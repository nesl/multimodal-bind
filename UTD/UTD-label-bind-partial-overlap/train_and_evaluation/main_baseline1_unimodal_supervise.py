...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='train_A', help='dataset')
...
def set_folder(opt, trial_id):
   ...
   # set the path according to the environment
    opt.save_path = './save_label_bind/save_baseline1/{}_{}/trial_{}/'.format(opt.dataset, opt.modality, trial_id)
