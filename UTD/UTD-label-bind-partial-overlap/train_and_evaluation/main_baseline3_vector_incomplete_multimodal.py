...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='train_AB', help='dataset')
...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_label_bind/save_baseline3_zero/trial_{}/'.format(trial_id)
...
def set_loader(opt):
    ...
    x_train_1, x_train_2, y_train, mask_train = data.load_all_data_incomplete_attach()
