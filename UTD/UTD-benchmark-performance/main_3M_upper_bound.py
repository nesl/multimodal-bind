...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}3M_upper_bound/trial_{}/'.format(opt.dataset,trial_id)
...
def set_loader(opt):
    ...
    x_train_1, x_train_2, y_train = data.load_all_data_IMU_upper_bound()
    x_train_3, _ = data.load_all_data_skeleton_upper_bound()

    print("test data:")
    x_test_1, x_test_2, y_test = data.load_data_IMU("test")
    x_test_3, _ = data.load_data_skeleton("test")

    train_dataset = data.Multimodal_3M_dataset(x_train_1, x_train_3, x_train_2, y_train)
    test_dataset = data.Multimodal_3M_dataset(x_test_1, x_test_3, x_test_2, y_test)
