...
class MyUTDmodel_acc(nn.Module):
    """Model for human-activity-recognition."""
    ...
    def forward(self, x1):
        ...
        output = self.classifier(acc_output)

        return output
    

class MyUTDmodel_gyro(nn.Module):
    """Model for human-activity-recognition."""
    def __init__(self, input_size, num_classes):
        super().__init__()
    ...
    def forward(self, x1):
        ...
        output = self.gyro_encoder(x1)   

        output = self.classifier(output)

        return output
    
class MyUTDmodel_skeleton(nn.Module):
    """Model for human-activity-recognition."""
    def __init__(self, input_size, num_classes):
        super().__init__()
    ...
    def forward(self, x1):
        ...
        output = self.skeleton_encoder(x1)   
