...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}3M_lower_bound/trial_{}/'.format(opt.dataset, trial_id)
...
def set_loader(opt):
    ...
    x_train_1, x_train_2, y_train = data.load_data_IMU(opt.dataset)
    x_train_3, _ = data.load_data_skeleton(opt.dataset)
