...
from models.fuse_2M_acc_gyro import MyUTDmodel_acc_gyro, MyUTDmodel_skeleton_gyro, MyUTDmodel_acc_skeleton
...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}2M_{}_upper_bound/trial_{}/'.format(opt.dataset, opt.modality, trial_id)
...
def set_loader(opt):
    ...
    x_train_label_1, x_train_label_2, y_train = data.load_all_data_IMU_upper_bound()
    x_train_label_3, _ = data.load_all_data_skeleton_upper_bound()

    print("test data:")
    x_test_label_1, x_test_label_2, y_test = data.load_data_IMU("test")
    x_test_label_3, _ = data.load_data_skeleton("test")

    if opt.modality == "acc_gyro":
        x_train_1 = x_train_label_1
        x_train_2 = x_train_label_2
        x_test_1 = x_test_label_1
        x_test_2 = x_test_label_2
    elif opt.modality == "skeleton_gyro":
        x_train_1 = x_train_label_3
        x_train_2 = x_train_label_2
        x_test_1 = x_test_label_3
        x_test_2 = x_test_label_2
    elif opt.modality == "acc_skeleton":
        x_train_1 = x_train_label_1
        x_train_2 = x_train_label_3
        x_test_1 = x_test_label_1
        x_test_2 = x_test_label_3
...
def set_model(opt):
    ...
    if opt.modality == "acc_gyro":
        model = MyUTDmodel_acc_gyro(input_size=1, num_classes=opt.num_class)
    elif opt.modality == "skeleton_gyro":
        model = MyUTDmodel_skeleton_gyro(input_size=1, num_classes=opt.num_class)
    elif opt.modality == "acc_skeleton":
        model = MyUTDmodel_acc_skeleton(input_size=1, num_classes=opt.num_class)
