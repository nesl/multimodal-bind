...
def parse_option():
    ...
    parser.add_argument('--modality', type=str, default='acc_gyro')
...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}2M_{}_lower_bound/trial_{}/'.format(opt.dataset, opt.modality, trial_id)
...
def set_loader(opt):
    ...
    x_train_label_3, _ = data.load_data_skeleton(opt.dataset)
