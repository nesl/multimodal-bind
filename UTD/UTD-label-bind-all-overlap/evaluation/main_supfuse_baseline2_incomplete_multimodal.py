...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}baseline2_zero/trial_{}/'.format(opt.dataset, trial_id)
...
def set_loader(opt):
    ...
    x_train_1, x_train_2, y_train, mask_train = data.load_data_incomplete(opt.dataset)
...
def load_multimodal_modal(opt):
    ...
    opt.ckpt = '../train/save_label_bind/save_baseline2_zero/trial_0/models/lr_0.0005_decay_0.0001_bsz_64/'
...
def set_model(opt):
    ...
    model = MyUTDmodel_2M(input_size=1, num_classes=opt.num_class)
