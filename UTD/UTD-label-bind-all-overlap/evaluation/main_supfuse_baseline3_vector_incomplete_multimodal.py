...
from models.fuse_2M_skeleton_gyro import MyUTDmodel_2M_mask
...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}baseline3_zero/trial_{}/'.format(opt.dataset, trial_id)
...
def load_multimodal_modal(opt):
    ...
    opt.ckpt = '../train/save_label_bind/save_baseline3_zero/trial_0/models/lr_0.0005_decay_0.0001_bsz_64/'
...
def set_model(opt):
    ...
    model = MyUTDmodel_2M_mask(input_size=1, num_classes=opt.num_class)
