...
do
    ...
    python3 train.py --gpu $gpu --exp_type mmbind --exp_tag unimod --dataset GR4DHCI --batch_size 64 --learning_rate 5e-4 --weight_decay 1e-3 --seed $j --modality skeleton --epochs 500
    ...
    # Step 3: pretrain the three modalities encoders on the combined dataset
     python3 train.py --gpu 0 --exp_type mmbind --exp_tag contrastive --dataset GR4DHCI --batch_size 64 --learning_rate 5e-4 --weight_decay 1e-3 --seed $j --modality skeleton --epochs 200
done