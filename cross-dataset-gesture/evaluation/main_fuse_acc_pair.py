...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../acc_bind/save_mmbind/save_acc_bind_contrastive_{}/models/lr_0.0005_decay_0.0001_bsz_128/'.format(opt.load_pretrain)
    opt.save_path = './save_{}/supfuse_acc_pair_{}_{}/trial_{}/'.format(opt.dataset, opt.train_ratio, opt.load_pretrain, trial_id)
...
def set_loader(opt, seed):
    ...
    print(x1_train.shape, x2_train.shape, x3_train.shape, y_train_select.shape)
    ...
    train_dataset = data.Multimodal_dataset(x1_train, x2_train, x3_train, y_train_select)
