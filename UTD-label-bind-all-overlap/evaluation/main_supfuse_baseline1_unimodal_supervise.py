...
def set_folder(opt, trial_id):
   ...
   # set the path according to the environment
    opt.save_path = './save_{}baseline1/trial_{}/'.format(opt.dataset, trial_id)
...
def set_loader(opt):
    ...
    x_train_label_1, x_train_label_2, y_train = data.load_single_dataset(opt.dataset)
...
def load_single_modal(opt, layer_key):
    ...
    if layer_key == 'skeleton_encoder.':
        opt.ckpt = '../train/save_label_bind/save_baseline1/train_A_skeleton/trial_0/models/lr_0.0005_decay_0.0001_bsz_64/'
    elif layer_key == 'gyro_encoder.':
        opt.ckpt = '../train/save_label_bind/save_baseline1/train_B_gyro/trial_0/models/lr_0.0005_decay_0.0001_bsz_64/'
