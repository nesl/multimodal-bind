...
def parse_option():
    ...
    parser.add_argument('--load_pretrain', type=str, default='load_self_AE_pretrain', help='load_pretrain, no_pretrain, load_self_AE_pretrain')
    parser.add_argument('--pretrain_dataset', type=str, default='train_AB', help='pretrain_dataset')
...
def set_folder(opt, trial_id):
    ...
    source_path = "./save_{}upper_bound_supcon/trial_{}/".format(opt.dataset, trial_id)
...
def set_loader(opt):
    ...
    x_train_AB_1, x_train_AB_2, y_train_AB = data.load_all_dataset()

    x_train_C_1, x_train_C_2, y_train_C = data.load_single_dataset(opt.dataset)

    x_train_label_1 = np.vstack((x_train_C_1, x_train_AB_1))
    x_train_label_2 = np.vstack((x_train_C_2, x_train_AB_2))
    y_train = np.hstack((y_train_C, y_train_AB))
