...
def parse_option():
    ...
    opt.save_path = "./save_mmbind/save_label_bind_contrastive_{}/".format(opt.load_pretrain)
...
def set_loader(opt):
    ...
    print("train data:")
    x_train_1, x_train_2, x_train_3, y = data.load_label_paired_data("acc_remain")

    train_dataset = data.Multimodal_dataset(x_train_1, x_train_2, x_train_3, y)
