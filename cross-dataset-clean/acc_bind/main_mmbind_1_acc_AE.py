...
from single_modality import MyIMUmodel_acc_AE
...
def parse_option():
    ...
    opt.save_path = './save_mmbind/acc_autoencoder/'
...
def set_loader(opt):
    ...
    train_dataset = data.Unimodal_dataset(x1, y)
...
def set_model(opt):
    ...
    model = MyIMUmodel_acc_AE(input_size=1)
