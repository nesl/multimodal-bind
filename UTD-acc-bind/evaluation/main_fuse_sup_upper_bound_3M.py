...
def parse_option():
    ...
    parser.add_argument('--incomplete', type=str, default='', help='blank or _incomplete')
...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../train/save_upper_bound/save_train_AB_3M{}_contrastive_{}/models/lr_0.001_decay_0.0001_bsz_64/'.format(opt.incomplete, opt.load_pretrain)
    source_path = "./save_{}upper_bound_{}_3M{}/trial_{}/".format(opt.dataset, opt.load_pretrain, opt.incomplete, trial_id)
