...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../train/save_baseline5/save_train_AB_dual_contrastive_zero_{}/models/lr_0.0001_decay_0.0001_bsz_64/'.format(opt.load_pretrain)

    # set the path according to the environment
    opt.save_path = './save_{}baseline5_zero/trial_{}/'.format(opt.dataset, trial_id)
