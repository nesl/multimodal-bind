...
#     opt.ckpt = '../train/save_mmbind/save_train_all_paired_AB_incomplete_weighted_contrastive_{}/models/lr_0.0005_decay_0.0001_bsz_64/'.format(opt.load_pretrain)
#     source_path = "./save_{}mmbind_all_incomplete_weighted_{}/trial_{}/".format(opt.dataset, opt.load_pretrain, trial_id)
...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../train/save_mmbind/save_train_all_paired_AB_incomplete_contrastive_weighted_{}/models/lr_0.0005_decay_0.0001_bsz_64/'.format(opt.load_pretrain)
    source_path = "./save_test_{}mmbind_all_weighted_incomplete_{}/trial_{}/".format(opt.dataset, opt.load_pretrain, trial_id)
