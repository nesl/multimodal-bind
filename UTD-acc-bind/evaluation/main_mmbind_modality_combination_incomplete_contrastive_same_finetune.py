...
def parse_option():
    ...
    parser.add_argument('--inference_modality', type=str, default='skeleton_gyro', help='inference_modality')
...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../train/save_mmbind/save_train_all_paired_AB_incomplete_contrastive_{}/models/lr_0.0005_decay_0.0001_bsz_64/'.format(opt.load_pretrain)
    source_path = "./save_same_finetune_{}mmbind_{}_incomplete_{}/trial_{}/".format(opt.dataset, opt.inference_modality, opt.load_pretrain, trial_id)
...
def set_loader(opt):
    ...
    x_train_1, x_train_2, x_train_3, y_train, mask_train = data.load_data_incomplete_modality(opt.dataset, opt.inference_modality)

    print("test data:")
    x_test_1, x_test_2, x_test_3, y_test, mask_test = data.load_data_incomplete_modality("test", opt.inference_modality)
