...
from models.fuse_2M_acc_gyro import MyUTDmodel_2M
...
def load_single_modal(opt, layer_key):
    ...
    if layer_key == 'skeleton_encoder.':
        opt.ckpt = '../train/save_baseline1/save_train_A_autoencoder/models/lr_0.0001_decay_0.0001_bsz_64/'
    elif layer_key == 'gyro_encoder.':
        opt.ckpt = '../train/save_baseline1/save_train_B_autoencoder/models/lr_0.0001_decay_0.0001_bsz_64/'
