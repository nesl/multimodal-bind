...
def set_folder(opt, trial_id):
    ...
    source_path = "./save_fix_finetune_{}mmbind_{}_incomplete_{}/trial_{}/".format(opt.dataset, opt.inference_modality, opt.load_pretrain, trial_id)
...
def set_loader(opt):
    ...
    x_train_1, x_train_2, x_train_3, y_train, mask_train = data.load_data_incomplete_modality(opt.dataset, "skeleton_gyro")
