...
from models.fuse_3M_acc_skeleton_gyro import MyUTDmodel_3M_mask2
...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../train/save_baseline3/save_train_AB_vector2_incomplete_contrastive_zero_{}/models/lr_0.0001_decay_0.0001_bsz_64/'.format(opt.load_pretrain)

    # set the path according to the environment
    opt.save_path = './save_{}baseline3_2_zero/trial_{}/'.format(opt.dataset, trial_id)
...
def set_loader(opt):
    ...
    print("test data:")
    x_test_1, x_test_2, x_test_3, y_test, mask_test = data.load_data_incomplete_attach("test")
...
def set_model(opt):
    ...
    model = MyUTDmodel_3M_mask2(input_size=1, num_classes=opt.num_class)
