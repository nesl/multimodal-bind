...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../train/save_baseline4/save_train_all_generated_AB_contrastive_{}/models/lr_0.0001_decay_0.0001_bsz_64/'.format(opt.load_pretrain)
    source_path = "./save_{}baseline4_contrastive_{}/trial_{}/".format(opt.dataset, opt.load_pretrain, trial_id)
