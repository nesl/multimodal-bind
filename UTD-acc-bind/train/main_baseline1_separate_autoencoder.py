...
from models.single_modality import MyUTDmodel_skeleton_AE, MyUTDmodel_gyro_AE
...
def set_loader(opt):
    ...
    print("train single-modal data:")
    x_train_1, x_train_2, y_train = data.load_single_dataset(opt.dataset)
