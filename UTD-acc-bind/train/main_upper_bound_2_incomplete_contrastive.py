...
def set_loader(opt):
    ...
    print("train data:")
    x_train_1, x_train_2, x_train_3, y_train = data.load_upper_bound_all_incomplete_dataset()

    train_dataset = data.Multimodal_3M_dataset(x_train_1, x_train_2, x_train_3, y_train)
...
def train(train_loader, model, criterion, optimizer, epoch, opt):
    ...
    for idx, (input_data1, input_data2, input_data3, label) in enumerate(train_loader):
