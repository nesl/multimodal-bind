...
from models.single_modality import MyUTDmodel_skeleton_AE, MyUTDmodel_gyro_AE, MyUTDmodel_acc_AE
...
def parse_option():
    ...
    parser.add_argument('--modality', type=str, default='skeleton',
                        choices=['acc', 'skeleton', 'gyro'], help='modality')
...
def set_loader(opt):
    ...
    print("train data:")
    x_train_1, x_train_3, y_train = data.load_all_data_IMU()
    x_train_2, _ = data.load_all_data_skeleton()
...
def set_model(opt):
    ...
    if opt.modality == "acc":
        ...
        model = MyUTDmodel_skeleton_AE(input_size=1)
    elif opt.modality == "gyro":
