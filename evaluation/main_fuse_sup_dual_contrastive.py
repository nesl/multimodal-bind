...
def parse_option():
    ...
    opt.save_path = './save_{}dual_contrastive/'.format(opt.dataset)
...
def set_model(opt):
    ...
    model_template.load_state_dict(torch.load('../train/save_dual_contrastive/save_train_AB_contrastive_no_pretrain/models/lr_0.001_decay_0.0001_bsz_64/last.pth')['model'])
