...
def parse_option():
    ...
    opt.save_path = './save_{}baseline1/'.format(opt.dataset)
...
def set_model(opt):
    ...
    model_template.load_state_dict(torch.load('../train/save_baseline1/save_train_A_autoencoder/models/lr_0.005_decay_0.0001_bsz_64/last.pth')['model'])
    model.gyro_encoder = model_template.encoder

    model_template.load_state_dict(torch.load('../train/save_baseline1/save_train_B_autoencoder/models/lr_0.005_decay_0.0001_bsz_64/last.pth')['model'])
