...
def parse_option():
    ...
    opt.save_path = "./save_baseline2/save_{}_incomplete_contrastive_zero_{}/".format(opt.dataset, opt.load_pretrain)
...
def set_model(opt):
    ...
    # We are never loading pretrained AE as a initialization, remove this for clarity
...
def train(train_loader, model, criterion, optimizer, epoch, opt):
    ...
    for idx, batched_data in enumerate(train_loader):
        ...
        features = FeatureConstructor(feature_dict['img'], feature_dict['depth'], feature_dict['semseg'])
