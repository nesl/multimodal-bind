...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}_weighted_mmbind/trial_{}/'.format(opt.dataset, trial_id)
...
def set_model(opt):
    model_template = Incomplete_Contrastive_3M()
    model_template.load_state_dict(torch.load('../train/save_mmbind/save_train_all_paired_AB_incomplete_contrastive_weighted_no_pretrain/models/lr_5e-05_decay_0.0001_bsz_64/last.pth')['model'])
