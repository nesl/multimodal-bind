...
from models.models import SupervisedDepthSemseg, DepthAE, SemSegAE
...
def set_model(opt):
    depth_template = DepthAE()
    semseg_template = SemSegAE()
    ...
    model.semseg_encoder = semseg_template.enc
    model.depth_encoder = depth_template.enc
