...
def set_model(opt):
    ...
    model_template.load_state_dict(torch.load('./save_imagebind/save_train_AB_acc_autoencoder_no_load_acc_100_split_0/models/lr_0.0001_decay_0.0001_bsz_64/last.pth')['model'])
...
def train(train_loader, model, criterion, optimizer, epoch, opt):
    ...
    for idx, batched_data in enumerate(train_loader):
        ...
        common_mod_embed = mod_embed['acc']
        ...
        features = FeatureConstructor(common_mod_embed, mod_embed['gyro'], 2)
...
def main():
    opt = parse_option("save_imagebind", "contrastive")
