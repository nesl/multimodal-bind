...
def set_model(opt):
    ...
    if opt.pairing:
        weight = f"./save_upperbound_label/save_train_AB_upperbound_no_load_{opt.common_modality}_{opt.seed}_{opt.dataset_split}/models/lr_0.0001_decay_0.0001_bsz_64/last.pth"
...
def main():
    ...
    opt = parse_option("save_upperbound_label", "upperbound")
