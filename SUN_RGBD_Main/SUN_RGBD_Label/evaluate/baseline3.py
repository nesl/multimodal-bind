...
def set_model(opt):
    ...
    model.load_state_dict(torch.load('../train/save_baseline3/save_train_AB_vector2_incomplete_contrastive_zero_no_pretrain/models/lr_0.0001_decay_0.0001_bsz_64/last.pth')['model'])
