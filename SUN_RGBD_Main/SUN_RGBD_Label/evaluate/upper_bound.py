...
from models.models import IncompleteSupervised, Incomplete_Contrastive_3M
...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../train/save_upper_bound/save_train_AB_supervised_no_pretrain/models/lr_0.0001_decay_0.0001_bsz_64/last.pth'
