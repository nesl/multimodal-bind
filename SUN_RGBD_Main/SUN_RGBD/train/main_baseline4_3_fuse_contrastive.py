...
def set_loader(opt):
    ...
    trainA = PickleDataset(root='./save_baseline4/train_A_generated_AB')
    trainB = PickleDataset(root='./save_baseline4/train_B_generated_AB')
...
def train(train_loader, model, criterion, optimizer, epoch, opt):
    ...
    for idx, batched_data in enumerate(train_loader):
        ...
        features = FeatureConstructor(feature_dict['depth'], feature_dict['semseg'])
