...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}_baseline2/trial_{}/'.format(opt.dataset, trial_id)
...
def set_model(opt):
    ...
    model_template.load_state_dict(torch.load('../train/save_baseline2/save_train_AB_incomplete_contrastive_zero_no_pretrain/models/lr_0.0001_decay_0.0001_bsz_64/last.pth')['model'])
