...
from models.models import SupervisedDepthSemseg, Incomplete_Contrastive_3M
...
def set_folder(opt, trial_id):
    ...
    opt.save_path = './save_{}_imagebind/trial_{}/'.format(opt.dataset, trial_id)
...
def set_model(opt):
    semseg_template = Incomplete_Contrastive_3M()
    semseg_template.load_state_dict(torch.load('../train/save_imagebind/save_train_A_dual_contrastive_zero_no_pretrain/models/lr_0.0001_decay_0.0001_bsz_64/last.pth')['model'])

    depth_template = Incomplete_Contrastive_3M()
    depth_template.load_state_dict(torch.load('../train/save_imagebind/save_train_B_dual_contrastive_zero_no_pretrain/models/lr_0.0001_decay_0.0001_bsz_64/last.pth')['model'])
    
    model = SupervisedDepthSemseg()
    model.semseg_encoder = semseg_template.semseg_enc
    model.depth_encoder = depth_template.depth_enc
