...
def set_folder(opt, trial_id):
    ...
    opt.ckpt = '../train/save_upper_bound/save_train_AB_3M_incomplete_contrastive_load_pretrain/models/lr_0.0001_decay_0.0001_bsz_64/last.pth'
    opt.save_path = './save_upper_bound/trial_{}/'.format(trial_id)
...
def set_model(opt):
    ...
    model_template.load_state_dict(torch.load(opt.ckpt)['model'])
