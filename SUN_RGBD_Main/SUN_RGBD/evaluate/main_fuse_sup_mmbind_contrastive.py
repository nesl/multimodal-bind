...
def set_model(opt):
    ...
    model_template.load_state_dict(torch.load('../train/save_mmbind/save_train_all_paired_AB_contrastive_no_pretrain/models/lr_0.0001_decay_0.0001_bsz_64/last.pth')['model'])
