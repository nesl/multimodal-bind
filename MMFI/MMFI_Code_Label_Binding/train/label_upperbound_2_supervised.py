...
def parse_option():
    ...
    opt.save_path = './save_upper_bound/save_supervised/'
...
def set_model(opt):
    ...
    checkpoint = './save_upper_bound/save_train_AB_incomplete_no_pretrain/models/lr_0.0005_decay_0.0001_bsz_32/last.pth'
