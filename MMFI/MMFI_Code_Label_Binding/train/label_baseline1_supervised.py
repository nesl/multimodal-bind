...
def parse_option():
    ...
    # TODO changed
    parser.add_argument("--train_config", type=str, default="../Configs/config_train_A.yaml", help="Configuration YAML file")
    ...
    opt.save_path = './save_unimodal_' + '_'.join(opt.modality) + '/'
...
def set_model(opt):
    ...
    model = model_lib.AllModsSupervised(opt.modality)
