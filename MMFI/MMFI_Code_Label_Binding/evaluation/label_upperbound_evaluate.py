...
def set_model(opt):
    ...
    model.load_state_dict(torch.load('../train/save_upper_bound/save_supervised/models/lr_0.0003_decay_0.0001_bsz_32/last.pth')['model'])
