...
def set_model(opt):
    ...
    checkpoint = '../train/save_baseline4/save_train_all_paired_AB_contrastive_no_pretrain/models/lr_0.0001_decay_0.0001_bsz_32/last.pth'
