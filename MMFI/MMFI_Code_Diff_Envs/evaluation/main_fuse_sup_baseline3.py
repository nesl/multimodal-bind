...
def set_model(opt):
    ...
    model_template = model_lib.ContextDualContrastive()
    checkpoint = '../train/save_baseline3/save_train_AB_mask_contrastive_no_pretrain/models/lr_0.0001_decay_0.0001_bsz_32/last.pth'
