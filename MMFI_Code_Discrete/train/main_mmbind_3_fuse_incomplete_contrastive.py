...
from models.model import DualContrastiveModel, DualContrastiveModelOld
...
def set_model(opt):
    ...
    # model_template = DualContrastiveModelOld()
    # model_template.load_state_dict(torch.load('./last.pth')['model'])
    # model.depth_encoder = model_template.depth_encoder
    # model.mmWave_encoder = model_template.mmWave_encoder
    # model.skeleton_encoder = model_template.skeleton_encoder
