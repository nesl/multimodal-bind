...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='train_all_paired_AB', 
                        choices=['train_mag_paired_AB', 'train_gyro_paired_AB', 'train_all_paired_AB'], help='dataset')
    parser.add_argument('--load_pretrain', type=str, default='no_pretrain', help='Pretraining')
