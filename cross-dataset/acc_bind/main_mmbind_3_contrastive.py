...
from fuse_3M_acc_gyro_mag import MyIMUmodel_3M_contrastive
from contrastive_design_3M import ConFusionLoss, FeatureConstructor
...
def parse_option():
    ...
    opt.save_path = "./save_mmbind/save_acc_bind_contrastive_{}/".format(opt.load_pretrain)
...
def set_loader(opt):
    ...
    print("train data:")
    x_train_1, x_train_2, x_train_3, similarity = data.load_all_paired_data()

    train_dataset = data.Multimodal_paired_dataset(x_train_1, x_train_2, x_train_3, similarity)
...
def set_model(opt):
    ...
    model = MyIMUmodel_3M_contrastive(input_size=1)
